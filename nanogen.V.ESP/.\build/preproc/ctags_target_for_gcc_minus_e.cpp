# 1 "/home/jus/projects/gitManage/NanoGen/ed/relay_V.1.0/nanogen.V.ESP/nanogen.V.ESP.ino"
/*
...
*/
# 7 "/home/jus/projects/gitManage/NanoGen/ed/relay_V.1.0/nanogen.V.ESP/nanogen.V.ESP.ino"
# 8 "/home/jus/projects/gitManage/NanoGen/ed/relay_V.1.0/nanogen.V.ESP/nanogen.V.ESP.ino" 2
# 9 "/home/jus/projects/gitManage/NanoGen/ed/relay_V.1.0/nanogen.V.ESP/nanogen.V.ESP.ino" 2
# 10 "/home/jus/projects/gitManage/NanoGen/ed/relay_V.1.0/nanogen.V.ESP/nanogen.V.ESP.ino" 2
# 11 "/home/jus/projects/gitManage/NanoGen/ed/relay_V.1.0/nanogen.V.ESP/nanogen.V.ESP.ino" 2
# 12 "/home/jus/projects/gitManage/NanoGen/ed/relay_V.1.0/nanogen.V.ESP/nanogen.V.ESP.ino" 2
...
# 20 "/home/jus/projects/gitManage/NanoGen/ed/relay_V.1.0/nanogen.V.ESP/nanogen.V.ESP.ino" 2
# 21 "/home/jus/projects/gitManage/NanoGen/ed/relay_V.1.0/nanogen.V.ESP/nanogen.V.ESP.ino" 2
# 22 "/home/jus/projects/gitManage/NanoGen/ed/relay_V.1.0/nanogen.V.ESP/nanogen.V.ESP.ino" 2
# 23 "/home/jus/projects/gitManage/NanoGen/ed/relay_V.1.0/nanogen.V.ESP/nanogen.V.ESP.ino" 2
...
# 1 "/home/jus/projects/gitManage/NanoGen/ed/relay_V.1.0/nanogen.V.ESP/_func_commun.ino"
/* data format
...
*/
# 10 "/home/jus/projects/gitManage/NanoGen/ed/relay_V.1.0/nanogen.V.ESP/_func_commun.ino"
//communicate with Relay=======================================================
void relayInit(){
  for(int i=0;i<relayNo;i++){
    pinMode(relayCh[i], 0x01);
    digitalWrite(relayCh[i], 0x1); //Turn off all relay.
  }
  delay(1000);
...
void relayControl(){
  if(mngState.req==1){
    digitalWrite(relayCh[waterPump], 0x0);
    if(mngState.mod==0){
      digitalWrite(relayCh[airPump], 0x0);
    }else{
      digitalWrite(relayCh[solenoid], 0x0);
    }
  }else if(mngState.req==0){
    for(int i=0;i<relayNo;i++){
      digitalWrite(relayCh[i], 0x1);
    }
  }
  //relayState();
}
...
# 1 "/home/jus/projects/gitManage/NanoGen/ed/relay_V.1.0/nanogen.V.ESP/_func_eeprom.ino"
//EEPROM--------------------------------------------------------
...
# 1 "/home/jus/projects/gitManage/NanoGen/ed/relay_V.1.0/nanogen.V.ESP/_func_webserver.ino"
//CTRLER-----------------------------------------------------------------------
String CTRL_THINGS(){
  String THINGS_HTML = (reinterpret_cast<const __FlashStringHelper *>(INDEX_HEAD));
  THINGS_HTML += "<h3 align: center>";
  THINGS_HTML += mngConf.mcuID;
  THINGS_HTML += "</h3>";
  THINGS_HTML += (reinterpret_cast<const __FlashStringHelper *>(BODY_CTRL));
  if(sizeof mngState.errorMsg > 20){
    THINGS_HTML += mngState.errorMsg;
    Serial.printf(mngState.errorMsg); nxEnd();
  }
  THINGS_HTML += (reinterpret_cast<const __FlashStringHelper *>(BODY_CONFIG1));
  ...
  THINGS_HTML += (reinterpret_cast<const __FlashStringHelper *>(BODY_CONFIG2));
  return THINGS_HTML;
}
...
# 1 "/home/jus/projects/gitManage/NanoGen/ed/relay_V.1.0/nanogen.V.ESP/main.ino"
void connectAP(){
  WiFi.disconnect();
  //WiFi.mode(WIFI_AP);
  delay(10);
